...
persistence operation, which fully couples memory consistency with persistence, or they fail to enforce certain 
orderings, which makes LFD recovery non-trivial. 
