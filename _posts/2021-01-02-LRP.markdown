...
reordered after it. 
On x86 platforms, both requirements are naturally acheived with TSO, which disallows load-store, store-load, store-store
and load-load reordering.