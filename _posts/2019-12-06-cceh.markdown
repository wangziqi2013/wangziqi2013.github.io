...
to the buddy allocation system, in which a chunk of memory whose size is a power of two is broken down into to equally 
halfs until the desired size (rounded up to power of two) is reached. The last 