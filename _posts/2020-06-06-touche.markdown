...
enabled for this slot, stores the 27 bit address tag. If one or more compressed blocks are invalid, the signature value 
is insignificant, and the actual tag comparison logic will find this out. 
