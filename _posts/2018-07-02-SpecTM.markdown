...
lock bits as per-item metadata, but this is crafted in a careful way such that the metadata and actual data item
...
of reads proceeds by directly comparing values of data items. 
