...
It does not seem that timing of the page fault is simulated, since the actual page fault handling runs as an OS thread, 
which can be simulated just like any instruction stream.
