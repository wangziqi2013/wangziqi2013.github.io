...
Also note that the tracking structures, such as `PENDING_PAGE_FAULTS`, `MAPPED_PAGE_SIZE`, and the page table objects,
...
both `stall` and `hold` will be cleared, allowing page walk requests to be served on all page table walkers.
