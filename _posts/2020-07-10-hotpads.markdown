...
bits, as well as dirty and valid bits. In addition, non-canonical objects are always stored with a header indicating its 
canonical address. This canonical address serves as the identity of the copy.
