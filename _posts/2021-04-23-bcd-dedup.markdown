...
This two-level scheme exploits both inter-line redundancy by only storing line delta, and intra-line redundancy
by compressing the delta value and performing deduplication of these deltas, which are expected to yield higher
