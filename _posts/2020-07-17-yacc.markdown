...
request, the controller first compresses the block. If the write back address hits the cache, indicating that a 
slot has already been allocated to the cache line, 
