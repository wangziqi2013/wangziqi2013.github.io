...
of cache line size, and then XOR'ing the content of the line with the OTP. The generation of OPT takes both the 
address of the line and the line's counter value, which are 