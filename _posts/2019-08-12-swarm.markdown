...
the specific semantics. Third, unnecessary data dependencies are introduced if we maintain tasks using software structures. 
...
the queue, but this dependency can be eliminated if hardware can track the structure of task creation.