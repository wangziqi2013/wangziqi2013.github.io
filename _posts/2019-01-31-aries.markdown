...
checkpoint. New transactions  (2) Dirty pages can leave and re-enter the table. In the previous case, it actually does not matter because 
...
On recovery, ARIES first runs an analysis algorithm to compute 