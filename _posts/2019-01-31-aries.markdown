...
compared the PageLSN with the LSN of the log entry. If the latter is smaller, then it indicates that the disk page is 
...
already been performed in the previous recovery attempt.