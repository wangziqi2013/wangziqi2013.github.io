...
with two or three bit code word type. Two bit code types are used for patterns and/or dictionary matches with higher 
frequencies, while three bit code word types are used for cases with lower frequencies.
