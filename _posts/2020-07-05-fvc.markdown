...
to the next level of the hierarchy. When the fill request is completed, the block is inserted into the L1 cache, and the 
evicted L1 block is inserted into FVC. 
