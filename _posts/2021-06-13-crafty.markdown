...
Before the commit of hardware transaction, a timestamp is obtained from a global and monotonically
...
After the hardware transaction commits, the undo log is flushed back to the NVM using clwb.
