...
1. File systems designed for DAX NVM can adopt HTM to guarantee both atomicity and durability.
...
3. Page allocator can be extra-protected with logical logging such that speculatively allocated and 
