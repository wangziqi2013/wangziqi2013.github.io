...
collection of code and data in page granularity. Each module has a long form identifier, which is the hash value of 
the module's initial code and data pages after being loaded into the main memory. 
