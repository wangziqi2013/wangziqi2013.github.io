...
This approach, however, is agnostic to the copy overhead and unmovable pages (e.g., pages for kernel data structures). 
...
Page compaction is prioritizes for those that do not have unmovable contents, and with the minimum amount of 
data to copy.
