...
on certain locations of the program to enforce the correct write ordering dependency between log entries and dirty cache lines. 
COW copies data under modification to a new location, and 
then changes the mapping to allow in-place update of data.