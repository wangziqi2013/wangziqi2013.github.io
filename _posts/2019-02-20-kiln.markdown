...
slightly different smaller parts. In the first part, we want consistency. Data structures are supposed to remain in a 
consistent state after recovery. Since system can crash any moment during the execution, the exact state of the data structure 
is hard to know at the time of the crash. To solve this problem, 
