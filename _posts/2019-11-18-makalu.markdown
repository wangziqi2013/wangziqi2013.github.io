...
heap, an array of root objects, the address of the block header map, the address of the logging area, the addresses of 
block headers, etc. The paper assumes that the file is always mapped to the same virtual address, and hence absolute 
virtual address pointers can be used. 
