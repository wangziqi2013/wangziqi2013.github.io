...
cache line in the cache either to retain atomicity of data operations or to protect the line from cache thrashing.
...
when a new cache line is to be brought into the same set. 
